        ...
        <div className="overflow-hidden rounded-lg relative">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative w-full h-[300px] sm:h-[400px] rounded-lg overflow-hidden bg-gradient-to-br from-[#111] to-[#222] border border-white/10"
            >
              <div className="absolute inset-0 flex flex-col justify-end p-6">
                <h3 className="text-2xl sm:text-3xl font-sora font-bold text-white mb-2">
                  {current.title}
                </h3>
